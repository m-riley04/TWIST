...
export interface ConcessionsDocumentItemProps {
    id: number;
    index: number;
    points: number;
    description: string;
...
const ConcessionsDocumentItem: React.FC<ConcessionsDocumentItemProps> = ({
    id,
    //index,
    points,
    description,
...
export default ConcessionsDocumentItem;
